...
def test_extract(example_path):
    ...
    for ds in data:
        assert (
            "reference_to_reference_flow" in ds
        ), "missing ref to ref.flow"  # used to identify ref. flow

        for e in ds["exchanges"]:
            assert (
                "exchanges_internal_id" in e
            ), "missing internal id"  # used to identify ref. flow
